...
def testExerciseLS(folder):
	...
	filePath=checkTargetFile(folder,targetFile)
	if filePath=="-":
		print ("CORRECTOR:", targetFie, "no encontrado")
		return "-"
...
if(__name__=="__main__"):
	...
	if (sys.version_info[0] < 3):
		print ('ERROR: Se debe usar python3\n\tpython3 probador_ssoo_p1.py <fichero_zip>')
		sys.exit(0)

	#Comprobamos que se ha pasado un fichero como argumento
	if not len(sys.argv) == 2:
		print ('Uso: python3 probador_ssoo_p1.py <fichero de codigo>')
	else:
